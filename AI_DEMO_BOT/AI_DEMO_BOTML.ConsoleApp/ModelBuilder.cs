...
namespace AI_DEMO_BOTML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\pshah6\source\repos\AI_DEMO_BOT\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../AI_DEMO_BOTML.Model/MLModel.zip";
