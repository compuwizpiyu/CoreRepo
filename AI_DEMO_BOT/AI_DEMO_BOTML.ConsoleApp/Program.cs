...
namespace AI_DEMO_BOTML.ConsoleApp
{
    class Program
    {
        //Dataset to use for predictions 
        private const string DATA_FILEPATH = @"C:\Users\pshah6\source\repos\AI_DEMO_BOT\wikipedia-detox-250-line-data.tsv";

        static void Main(string[] args)
        {
            // Create single instance of sample data from first line of dataset for model input
            ModelInput sampleData = new ModelInput() { SentimentText = "Hi", Sentiment = false };//CreateSingleDataSample(DATA_FILEPATH);
